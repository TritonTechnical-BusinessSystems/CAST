...
// Configuration sign-in (/login). The public download landing lives at /download;
// this route is reserved for the AD-primary / local-fallback admin sign-in.
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <button type="button" className="auth-back" onClick={() => navigate("/download")}>
          ← Back to download
        </button>
      </div>
    </div>
